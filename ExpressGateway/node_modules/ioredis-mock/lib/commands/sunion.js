...
function sunion() {
  ...
  var union = new _es6Set2.default(sets.reduce(function (combined, set) {
    return [].concat(_toConsumableArray(combined), _toConsumableArray((0, _arrayFrom2.default)(set)));
  }, []));
